...
return [
    ...
    'options' => [
        ...
        'closeButtonIcon' => 'rick-toast-close-icon',
        ...
        'positionClass' => 'rick-toast-top-right',
        ...
        'icons' => [
            'info' => 'rick-toast-info-icon',
            'warning' => 'rick-toast-warning-icon',
            'success' => 'rick-toast-success-icon',
            'error' => 'rick-toast-error-icon',
        ],
        ...
        'colorsClasses' => [
            'info' => 'rick-toast-info',
            'warning' => 'rick-toast-warning',
            'success' => 'rick-toast-success',
            'error' => 'rick-toast-error',
        ],
    ],
