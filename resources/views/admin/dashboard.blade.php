...
@section('content')
    ...
    <div class="row row-cols-1 row-cols-lg-2 row-cols-xxl-4 g-3 mb-3">
        <div class="col">
            <div class="rick-counter-card bg-c-1">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-dollar-sign"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">
                        {{ translate('Total Sales (:count)', ['count' => number_format($counters['total_sales'])]) }}
                    </p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['total_sales_amount']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-c-2">
                <div class="rick-counter-card-icon">
                ...
                <div class="rick-counter-card-meta">
                    ...
                    <p class="rick-counter-card-number">{{ getAmount($counters['support_sales_amount']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-c-6">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-box-open"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Items') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['total_items']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-c-7">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-cart-arrow-down"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Sales') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['total_sales']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-c-11">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-share"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Refunds') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['total_refunds']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-c-9">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-users"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Users') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['total_users']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-c-12">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-receipt"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Transactions') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['total_transactions']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-c-13">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-inbox"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Tickets') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['total_tickets']) }}</p>
                </div>
            </div>
        </div>
    </div>
    @if (licenseType(2) && @$settings->premium->status)
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xxl-3 g-3 mb-3">
            <div class="col">
                <div class="rick-counter-card bg-c-3">
                    <div class="rick-counter-card-icon">
                        <i class="fa-solid fa-crown"></i>
                    </div>
                    <div class="rick-counter-card-meta">
                        <p class="rick-counter-card-title">{{ translate('Free Subscriptions') }}</p>
                        <p class="rick-counter-card-number">
                            {{ number_format($counters['premium_free_subscriptions']) }}</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="rick-counter-card bg-c-4">
                    <div class="rick-counter-card-icon">
                        <i class="fa-solid fa-crown"></i>
                    </div>
                    <div class="rick-counter-card-meta">
                        <p class="rick-counter-card-title">{{ translate('Paid Subscriptions') }}</p>
                        <p class="rick-counter-card-number">
            ...
            <div class="col">
                <div class="rick-counter-card bg-c-5">
                    <div class="rick-counter-card-icon">
                        <i class="fa-solid fa-dollar-sign"></i>
                    </div>
                    <div class="rick-counter-card-meta">
                        <p class="rick-counter-card-title">{{ translate('Premium Earnings') }}</p>
                        <p class="rick-counter-card-number">
    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-lg-6 col-xxl-8">
            <div class="card h-100">
                <div class="rick-box chart-bar">
                    <div class="rick-box-header">
                        <p class="rick-box-header-title large mb-0">
                            {{ translate('Users Statistics For This Month') }}
                        </p>
                        <div class="rick-box-header-action ms-auto">
        ...
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="card h-100">
                <div class="rick-box v2">
                    <div class="rick-box-header mb-3">
                        <p class="rick-box-header-title large mb-0">{{ translate('Recently registered') }}</p>
                        <div class="rick-box-header-action ms-auto">
                            <button type="button" class="btn btn-sm rounded-3" data-bs-toggle="dropdown">
                                <i class="fa fa-ellipsis-v"></i>
                            </button>
                    ...
                    <div class="rick-box-body">
                        <div class="rick-random-lists">
                            @forelse ($users as $user)
                                <div class="rick-random-list">
                                    <div class="rick-random-list-cont">
                                        <a class="rick-random-list-img"
                                            href="{{ route('admin.members.users.edit', $user->id) }}">
                                            <img src="{{ $user->getAvatar() }}" />
                                        </a>
                                        <div class="rick-random-list-info">
                                            <div>
                                                <a class="rick-random-list-title fs-exact-14"
                                                    href="{{ route('admin.members.users.edit', $user->id) }}">
                                                    {{ $user->getName() }}
                                                </a>
                                                <p class="rick-random-list-text mb-0">
                                                    {{ $user->created_at->diffforhumans() }}
                                                </p>
                                            </div>
                                            <div class="rick-random-list-action d-none d-lg-block">
        ...
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="card h-100">
                <div class="rick-box v2">
                    <div class="rick-box-header mb-3">
                        <p class="rick-box-header-title large mb-0">{{ translate('Top Selling Items') }}</p>
                    </div>
                    <div class="rick-box-body">
                        <div class="rick-random-lists">
        ...
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="card h-100">
                <div class="rick-box v2">
                    <div class="rick-box-header mb-3">
                        <p class="rick-box-header-title large mb-0">{{ translate('Top Purchasing Countries') }}</p>
                    </div>
                    <div class="rick-box-body">
                        <div class="rick-random-lists">
                            @forelse ($topPurchasingCountries as $topPurchasingCountry)
                                <div class="rick-random-list py-2">
                                    <div class="rick-random-list-cont">
                                        <div class="rick-random-list-img">
                                            <img src="{{ countryFlag($topPurchasingCountry->country) }}"
                                                alt="{{ countries($topPurchasingCountry->country) }}" />
                                        </div>
                                        <div class="rick-random-list-info">
                                            <div>
                                                <div class="rick-random-list-title fs-exact-14">
                                                    {{ countries($topPurchasingCountry->country) }}
                                                </div>
                                            </div>
                                            <div class="rick-random-list-action">
