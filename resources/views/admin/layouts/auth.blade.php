...
<head>
    ...
    @adminColors
    <link rel="stylesheet" href="{{ asset('vendor/libs/rick/toastr/css/rick-toastr.min.css') }}">
...
<body>
    <div class="rick-sign-container">
        <div class="rick-sign-form">
            <a href="{{ route('admin.index') }}" class="rick-sign-logo">
    ...
    <script src="{{ asset('vendor/libs/rick/toastr/js/rick-toastr.min.js') }}"></script>
