        ...
        <div class="col-12 col-lg-6 col-xxl-6">
            <div class="rick-counter-card bg-green">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Opened tickets') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['opened_tickets'] }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl-6">
            <div class="rick-counter-card bg-red">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Closed tickets') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['closed_tickets'] }}</p>
                </div>
            </div>
        </div>
    </div>
