        ...
        <div class="col-12 col-lg-6">
            <div class="rick-counter-card bg-green">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Cedited') }}
                        ({{ numberFormat($counters['credit']['total']) }})</p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['credit']['amount']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6">
            <div class="rick-counter-card bg-danger">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Total Debited') }}
                        ({{ numberFormat($counters['debit']['total']) }})</p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['debit']['amount']) }}</p>
                </div>
            </div>
        </div>
    </div>
