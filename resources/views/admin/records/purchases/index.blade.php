    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="rick-counter-card bg-green">
                ...
                <div class="rick-counter-card-meta">
                    ...
                    <p class="rick-counter-card-number">{{ numberFormat($counters['active']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="rick-counter-card bg-blue">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Refunded') }}</p>
                    <p class="rick-counter-card-number">{{ numberFormat($counters['refunded']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-12 col-xxl-4">
            <div class="rick-counter-card bg-red">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Cancelled') }}</p>
                    <p class="rick-counter-card-number">{{ numberFormat($counters['cancelled']) }}</p>
                </div>
            </div>
        </div>
    </div>
