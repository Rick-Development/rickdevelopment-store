        ...
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="rick-counter-card bg-green">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Active') }}
                        ({{ numberFormat($counters['active']['total']) }})</p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['active']['amount']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="rick-counter-card bg-blue">
                <div class="rick-counter-card-bg"></div>
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-share"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Refunded') }}
                        ({{ numberFormat($counters['refunded']['total']) }})</p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['refunded']['amount']) }}</p>
                </div>
            </div>
        </div>
