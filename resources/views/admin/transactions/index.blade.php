        ...
        <div class="col">
            <div class="rick-counter-card bg-orange">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Pending') }}
                        ({{ numberFormat($counters['pending']['total']) }})</p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['pending']['amount']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-green">
                <div class="rick-counter-card-bg"></div>
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-check"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Paid') }}
                        ({{ numberFormat($counters['paid']['total']) }})</p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['paid']['amount']) }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-red">
                <div class="rick-counter-card-bg"></div>
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-xmark"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Cancelled') }}
                        ({{ numberFormat($counters['cancelled']['total']) }})</p>
                    <p class="rick-counter-card-number">{{ getAmount($counters['cancelled']['amount']) }}</p>
                </div>
            </div>
        </div>
    </div>
