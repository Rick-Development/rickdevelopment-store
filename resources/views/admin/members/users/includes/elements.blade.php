<div class="row row-cols-1 row-cols-lg-3 row-cols-xxl-3 g-3 mb-4">
    <div class="col">
        <div class="rick-counter-card bg-c-1">
            ...
            <div class="rick-counter-card-meta">
                <p class="rick-counter-card-title">{{ translate('Balance') }}</p>
                <p class="rick-counter-card-number">{{ getAmount($user->balance) }}</p>
            </div>
            <div class="ms-auto">
    ...
    <div class="col">
        <div class="rick-counter-card bg-c-2">
            ...
            <div class="rick-counter-card-meta">
                <p class="rick-counter-card-title">{{ translate('Purchases') }}</p>
                <p class="rick-counter-card-number">{{ number_format($user->purchases_count) }}</p>
            </div>
        </div>
    </div>
    <div class="col">
        <div class="rick-counter-card bg-c-6">
            ...
            <div class="rick-counter-card-meta">
                <p class="rick-counter-card-title">{{ translate('Total Spend') }}</p>
                <p class="rick-counter-card-number">{{ getAmount($counters['total_transactions_amount']) }}</p>
            </div>
        </div>
    </div>
</div>
