...
@section('content')
    <div class="row g-3 row-cols-lg-{{ @$settings->kyc->status ? '3' : '4' }} mb-4">
        <div class="col">
            <div class="rick-counter-card bg-c-8">
                <div class="rick-counter-card-icon">
                    <i class="fa fa-users"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Active') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['active'] }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-danger">
                <div class="rick-counter-card-icon">
                    <i class="fa fa-ban"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Banned') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['banned'] }}</p>
                </div>
            </div>
        </div>
        @if (@$settings->kyc->status)
            <div class="col">
                <div class="rick-counter-card bg-c-14">
                    <div class="rick-counter-card-icon">
                        <i class="fa-solid fa-user-check"></i>
                    </div>
                    <div class="rick-counter-card-meta">
                        <p class="rick-counter-card-title">{{ translate('KYC Verified') }}</p>
                        <p class="rick-counter-card-number">{{ $counters['kyc_verified'] }}</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="rick-counter-card bg-c-5">
                    ...
                    <div class="rick-counter-card-meta">
                        <p class="rick-counter-card-title">{{ translate('KYC Unverified') }}</p>
                        <p class="rick-counter-card-number">{{ $counters['kyc_unverified'] }}</p>
                    </div>
                </div>
            </div>
        @endif
        <div class="col">
            <div class="rick-counter-card bg-success">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-envelope-circle-check"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Email Verified') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['email_verified'] }}</p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="rick-counter-card bg-gray">
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-envelope-open"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Email Unverified') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['email_unverified'] }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div>
            @if ($users->count() > 0)
                <div class="table-responsive">
                    <table class="rick-normal-table table w-100">
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <div class="rick-user-box">
                                            <a class="rick-user-avatar"
