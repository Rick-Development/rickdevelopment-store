...
@section('content')
    <form id="rick-submited-form" action="{{ route('admin.financial.payment-gateways.update', $paymentGateway->id) }}"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-4">
                        <div class="rick-file-preview-box mb-3 bg-light p-4 text-center">
