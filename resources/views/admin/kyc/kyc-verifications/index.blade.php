...
@section('content')
    <div class="row g-3 mb-4">
        <div class="col-12 col-lg-6 col-xxl">
            <div class="rick-counter-card bg-orange">
                <div class="rick-counter-card-bg"></div>
                <div class="rick-counter-card-icon">
                    <i class="fa-regular fa-hourglass-half"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Pending') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['pending'] }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl">
            <div class="rick-counter-card bg-success">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Approved') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['approved'] }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl">
            <div class="rick-counter-card bg-danger">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Rejected') }}</p>
                    <p class="rick-counter-card-number">{{ $counters['rejected'] }}</p>
                </div>
            </div>
        </div>
    </div>
