        ...
        <div class="col-12 col-lg-4">
            <div class="rick-counter-card bg-c-3">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Videos') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['videos']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-4">
            <div class="rick-counter-card bg-c-4">
                ...
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Audios') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['audios']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-4">
            <div class="rick-counter-card bg-secondary">
                <div class="rick-counter-card-bg"></div>
                <div class="rick-counter-card-icon">
                    <i class="fa-solid fa-box"></i>
                </div>
                <div class="rick-counter-card-meta">
                    <p class="rick-counter-card-title">{{ translate('Others') }}</p>
                    <p class="rick-counter-card-number">{{ number_format($counters['others']) }}</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="rick-item-box">
                                                <a class="rick-item-image"
