...
@section('content')
    ...
    <form id="rick-submited-form" action="{{ route('admin.blog.articles.update', $article->id) }}" method="POST"
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card h-100 p-2 mb-3">
                    <div class="card-body">
                        <div class="rick-file-preview-box mb-3 bg-light p-5 text-center">
