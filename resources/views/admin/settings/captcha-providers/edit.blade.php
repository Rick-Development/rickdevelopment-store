...
@section('content')
    <form id="rick-submited-form" action="{{ route('admin.settings.captcha-providers.update', $captchaProvider->id) }}"
        method="POST">
        @csrf
        <div class="card mb-4">
            <div class="card-body">
                <div class="rick-file-preview-box bg-light mb-3 p-4 text-center">
