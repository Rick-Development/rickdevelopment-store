...
<div class="offcanvas offcanvas-start" tabindex="-1" id="searchFillters" aria-labelledby="searchFilltersLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="searchFilltersLabel">{{ translate('Search Filters') }}</h5>
    ...
    <div class="offcanvas-body">
        ...
        <div class="box bg-color p-4 mb-4">
            ...
            <div class="filter-item">
                <div class="d-flex align-items-center gap-2">
                    <input id="priceForm1" type="text" name="min_price" class="form-control form-control-md"
                        placeholder="{{ translate('min') }}" value="{{ request()->input('min_price') }}" />
                    <span>-</span>
                    <input id="priceTo1" type="text" name="max_price" class="form-control form-control-md"
                        placeholder="{{ translate('max') }}" value="{{ request()->input('max_price') }}" />
                    <button id="searchByPrice" class="btn btn-primary btn-md btn-padding">
                        <i class="fa fa-arrow-right fa-rtl"></i>
                    </button>
