...
abstract class AbstractEndpoint implements EndpointInterface
{
    ...
    public function __construct(BasqetClient $client)
    {
        $this->client = $client;
    }

    private function getUrl($endpoint = null): string
    {
        return implode('/', [
    ...
    protected function request(string $method = self::METHOD_GET, $endpoint = null, array $data = [], array $query = []): array
    {
        $options = [
