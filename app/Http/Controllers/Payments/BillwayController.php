...
class BillwayController extends Controller
{
    private $paymentGateway;
    private $virtualAccount;
    private $billwayHelper;

    public function __construct()
    {
        $this->paymentGateway = paymentGateway('billway');
        $this->virtualAccount = new VirtualAccount();
        // $this->billwayHelper = new BillwayHelper(
        //     $this->paymentGateway->credentials->api_key,
        //     $this->paymentGateway->credentials->webhook_secret ?? null,
    ...
    public function process($trx)
    {
        ...
        try {
            ...
            $trx->payment_id = $paymentData['_id'];
            $trx->update();
