(function($) {
    ...
    if (dropdown !== null) {
        dropdown.forEach((el) => {
            let dropdownFunc = () => {
                let sideBarLinksMenu = el.querySelector('.rick-sidebar-link-menu');
            ...
            el.querySelector('.rick-sidebar-link-title').onclick = () => {
    ...
    let sideBar = document.querySelector('.rick-sidebar'),
        pageContent = document.querySelector('.rick-page-content'),
        sideBarIcon = document.querySelector('.rick-sibebar-icon');
    if (sideBar !== null) {
        sideBarIcon.onclick = () => {
    ...
    let sidebarLinkCounter = document.querySelectorAll(".rick-sidebar-link-title .counter");
    ...
    let navbarLinkCounter = document.querySelectorAll(".rick-notifications-title .counter");
    ...
    let commentView = $('.rick-view-comment'),
